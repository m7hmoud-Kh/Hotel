...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Rooms Type</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    ...
                    <form action="/admin/room_type/update" method="POST">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="type" name="type" value="{{$room_type->type}}" required>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">Price</label>
                                <input type="text" class="form-control form-control-lg" id="price" name="price" value="{{$room_type->price}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="description" rows="3"
                                    >  {{$room_type->description}} </textarea>
                            </div>
                        </div>
