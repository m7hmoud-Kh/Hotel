				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="">Receptionist</a></li>
							<li><a class="slide-item" href="">Room attendant</a></li>
							<li><a class="slide-item" href="">Doorman</a></li>
							<li><a class="slide-item" href="">Poter</a></li>
							<li><a class="slide-item" href="">Chefs</a></li>
						</ul>
					</li>
					<li class="slide">
